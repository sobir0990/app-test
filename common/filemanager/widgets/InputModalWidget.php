...
JS;
        ...
        if (strlen($this->values)) {
            ...
            foreach ($files as $file) {
                ...
                if (in_array($file->type, $this->pictures_ext)) {
                    $this->selected_items_sortable[$file->file_id]['content'] .= "<img class='col-md-4' style='height:50px; width:100px;' src='" . $file->getImageSrc() . "' />";
                }
                if (in_array($file->type, $this->video_ext)) {
                    $this->selected_items_sortable[$file->file_id]['content'] .= "<video class='col-md-4' style='height:auto; display:inline;' src='" . $file->getImageSrc() . "'> </video>";
                }
    ...
    document.filemanager' . $this->id . '.query();
        ...
        echo <<<HTML
        <a class="btn btn-tag   btn-tag-light btn-tag-rounded m-r-20" data-toggle="modal" data-target="#filemanagermodel{$this->id}" >Загрузить</a>
        {$sort_widget}
    ...
    <div class="modal-content">
      ...
      <div class="tab-pane in active" id="filemanager_files{$this->id}">
         <div class="row col-md-12 col-xs-12 col-lg-12">
             {$upload_widget}
            <div class="input-group" style="width: 90%;padding: 10px 0">
        ...
        <div class="row col-md-12 col-xs-12 col-lg-12">
            <div class="fileManagerList fileManagerList{$this->id}">
                    Loading....
            </div>  
